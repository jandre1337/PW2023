...
@section('content')
    <div class="d-flex justify-content-center"> <h1>Criar novo lugar</h1> <br> </div>
    <div class="col-12 col-md-6 col-lg-12" style="padding-top:5%;padding-bottom:5%;background-color:#e0e0e0;">
        ...
        <form action="/lugars/new" method="post">
            ...
            <div>
                <label for="localizacao">Piso:</label>
            ...
            <div>
                <input type="submit" value="Criar lugar">
            </div>
